...
The Python code for the example below can be found online in the ``DataXlCalcNet`` repository or in the corresponding local ``DataXlCalcNet`` folder in the file `D01_Platonic_Solid_Surface_Edges_Filled.py <https://github.com/duhadler/DataXlCalcNet/blob/master/DataXlCalcNet/A01_ExamplesPython/B20_Matplotlib3D/C07_EdgeToEdgeSurfaceColoring/D01_Platonic_Solid_Surface_Edges_Filled.py>`__, and the XML code in the file `D01_Platonic_Solid_Surface_Edges_Filled.2D.xml <https://github.com/duhadler/DataXlCalcNet/blob/master/DataXlCalcNet/GalleryOfPlotsExamples/B20_Matplotlib3D/C07_EdgeToEdgeSurfaceColoring/D01_Platonic_Solid_Surface_Edges_Filled.2D.xml>`__.
...
The Python code for the example below can be found online in the ``DataXlCalcNet`` repository or in the corresponding local ``DataXlCalcNet`` folder in the file `D02_Platonic_Solid_Surface_Edges_Filled.py <https://github.com/duhadler/DataXlCalcNet/blob/master/DataXlCalcNet/A01_ExamplesPython/B20_Matplotlib3D/C07_EdgeToEdgeSurfaceColoring/D02_Platonic_Solid_Surface_Edges_Filled.py>`__, and the XML code in the file `D02_Platonic_Solid_Surface_Edges_Filled.2D.xml <https://github.com/duhadler/DataXlCalcNet/blob/master/DataXlCalcNet/GalleryOfPlotsExamples/B20_Matplotlib3D/C07_EdgeToEdgeSurfaceColoring/D02_Platonic_Solid_Surface_Edges_Filled.2D.xml>`__.
...
The Python code for the example below can be found online in the ``DataXlCalcNet`` repository or in the corresponding local ``DataXlCalcNet`` folder in the file `D07_Line_Colormap_Sequence.py <https://github.com/duhadler/DataXlCalcNet/blob/master/DataXlCalcNet/A01_ExamplesPython/B20_Matplotlib3D/C07_EdgeToEdgeSurfaceColoring/D07_Line_Colormap_Sequence.py>`__, and the XML code in the file `D07_Line_Colormap_Sequence.2D.xml <https://github.com/duhadler/DataXlCalcNet/blob/master/DataXlCalcNet/GalleryOfPlotsExamples/B20_Matplotlib3D/C07_EdgeToEdgeSurfaceColoring/D07_Line_Colormap_Sequence.2D.xml>`__.
...
The Python code for the example below can be found online in the ``DataXlCalcNet`` repository or in the corresponding local ``DataXlCalcNet`` folder in the file `D08_Sequential_Line_Color.py <https://github.com/duhadler/DataXlCalcNet/blob/master/DataXlCalcNet/A01_ExamplesPython/B20_Matplotlib3D/C07_EdgeToEdgeSurfaceColoring/D08_Sequential_Line_Color.py>`__, and the XML code in the file `D08_Sequential_Line_Color.2D.xml <https://github.com/duhadler/DataXlCalcNet/blob/master/DataXlCalcNet/GalleryOfPlotsExamples/B20_Matplotlib3D/C07_EdgeToEdgeSurfaceColoring/D08_Sequential_Line_Color.2D.xml>`__.
